...
?>
    ...
    <?php if(isset($customize['font_family_second'])  && $customize['font_family_second'] != '---'){ ?>
        .breadcrumb-content-inner nav.breadcrumb li, .topbar .topbar-left ul.gva_menu > li a, .article-detail .post-categories a,
        .post-block .post-title a,.video-block .content .post-title a,.gallery-post .post-meta-wrap .post-title a,.testimonial-node-1 .testimonial-content .info .title,
        .btn-theme, .view-node a,.block .block-title > span,.menu-hover .navigation .gva_menu .megamenu > .sub-menu > li > a,
        .portfolio-filter ul.nav-tabs > li > a,.portfolio-v1 .content-inner .title a,.tags-list .item-list > ul > li a,.category-list ul > li a,
        .widget.gsc-icon-box .highlight_content .title,.gsc-tab-views.style-1 .list-links-tabs .nav-tabs > li a,.gsc-tab-views.style-2 .list-links-tabs .nav-tabs > li a,
        .gsc-service-carousel .item .content-inner .title a,.gavias-slider .gva-caption .caption-title,.gavias-slider .caption-title,
    ...
    <?php if(isset($customize['body_bg_image'])  && $customize['body_bg_image']){ ?>
        body{
            background-image:url('<?php echo drupal_get_path('theme', 'gavias_kama') .'/images/patterns/'. $customize['body_bg_image']; ?>');
        }
    <?php } ?> 
